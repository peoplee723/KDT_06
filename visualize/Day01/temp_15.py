...
def main():
    ...
    weather_df=pd.read_csv('daegu-uft8-df.csv', encoding='utf-8-sig')
    ...
    for year in range(10):
        ...
        print(second_decade_max_temp_list)
    ...
    # print(f'{first_decade}년대 {search_month}월 최고 기온 평균: {first_decade_high_temp_mean}')
    # print(f'{second_decade}년대 {search_month}월 최고 기온 평균: {second_decade_high_temp_mean}')
