...
dust= dust[['date','year', 'month', 'day', 'so2', 'co', 
            'o3', 'no2', 'PM10', 'PM2.5', ]]
print(dust.columns)
...
merged_df.hist(column=['so2', 'co', 'o3', 'no2', 'PM10','PM2.5', 'temp',
                       'wind', 'rain', 'humidity'],bins=50, figsize=(20,15))
plt.show()

plt.figure(figsize=(15,10))
daygrah= sns.barplot(x='day', y='PM10', data=merged_df)
