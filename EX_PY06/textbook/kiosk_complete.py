...
class Hamburger:                                    
    ...
    def remove_ingredient(self, ingredient):
        if ingredient in self.ingredients:
            ...
            print(f"{self.burger_name}에 더 이상 {ingredient} 을/를 제거할 수 없습니다.")
                ...
                while ing_bool:
                    ...
                    if extra==1:
                        while True:
                            ...
                            if choice_ing==1:
                                burger.add_ingredient('패티');break 
                            elif choice_ing==2:
                                burger.add_ingredient('양상추');break 
                            elif choice_ing==3:
                                burger.add_ingredient('치즈');break 
                            elif choice_ing==4:
                                burger.add_ingredient('토마토');break 
                            elif choice_ing==5:
                                burger.add_ingredient('피클') ;break 
                            elif choice_ing==6:
                        ...
                        while True:
                            ...
                            if choice_ing==1:
                                burger.remove_ingredient('패티');break 
                            elif choice_ing==2:
                                burger.remove_ingredient('양상추');break 
                            elif choice_ing==3:
                                burger.remove_ingredient('치즈');break 
                            elif choice_ing==4:
                                burger.remove_ingredient('토마토');break 
                            elif choice_ing==5:
                                burger.remove_ingredient('피클') ;break 
                            elif choice_ing==6:
                                print('이전 화면으로 돌아갑니다');break 
                            elif check==False: print(f'{choice_ing}는 올바르지 않은 번호입니다.');continue
                            else: print(f'{choice_ing}는 올바르지 않은 번호입니다.');continue
